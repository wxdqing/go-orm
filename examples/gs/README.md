...
`orm.option.proto` 真源：[protoc-gen-go-orm/options/orm.option.proto](../../../protoc-gen-go-orm/options/orm.option.proto)（Tcaplus 选项见 tcaplus 生成物，本示例不测）。
...
插件侧更全的选项演示见 [protoc-gen-go-orm/examples](../../../protoc-gen-go-orm/examples/)。
