...
func (x *GameRole) Reset() {
	*x = GameRole{}
	mi := &file_tb_game_role_proto_msgTypes[0]
...
func (*GameRole) Descriptor() ([]byte, []int) {
	return file_tb_game_role_proto_rawDescGZIP(), []int{0}
}
...
func (x *RoleHero) Reset() {
	*x = RoleHero{}
	mi := &file_tb_game_role_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RoleHero) Descriptor() ([]byte, []int) {
	return file_tb_game_role_proto_rawDescGZIP(), []int{1}
}
...
func (x *RoleTimestamps) Reset() {
	*x = RoleTimestamps{}
	mi := &file_tb_game_role_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RoleTimestamps) Descriptor() ([]byte, []int) {
	return file_tb_game_role_proto_rawDescGZIP(), []int{2}
}
...
var File_tb_game_role_proto protoreflect.FileDescriptor

const file_tb_game_role_proto_rawDesc = "" +
	"\n" +
	"\x12tb_game_role.proto\x12\x05mysql\"\xba\x02\n" +
	"\bGameRole\x12\x1b\n" +
...
var (
	file_tb_game_role_proto_rawDescOnce sync.Once
	file_tb_game_role_proto_rawDescData []byte
)

func file_tb_game_role_proto_rawDescGZIP() []byte {
	file_tb_game_role_proto_rawDescOnce.Do(func() {
		file_tb_game_role_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tb_game_role_proto_rawDesc), len(file_tb_game_role_proto_rawDesc)))
	})
	return file_tb_game_role_proto_rawDescData
}

var file_tb_game_role_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_tb_game_role_proto_goTypes = []any{
	(*GameRole)(nil),       // 0: mysql.GameRole
	(*RoleHero)(nil),       // 1: mysql.RoleHero
	(*RoleTimestamps)(nil), // 2: mysql.RoleTimestamps
}
var file_tb_game_role_proto_depIdxs = []int32{
...
func init() { file_tb_game_role_proto_init() }
func file_tb_game_role_proto_init() {
	if File_tb_game_role_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tb_game_role_proto_rawDesc), len(file_tb_game_role_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_tb_game_role_proto_goTypes,
		DependencyIndexes: file_tb_game_role_proto_depIdxs,
		MessageInfos:      file_tb_game_role_proto_msgTypes,
	}.Build()
	File_tb_game_role_proto = out.File
	file_tb_game_role_proto_goTypes = nil
	file_tb_game_role_proto_depIdxs = nil
}
