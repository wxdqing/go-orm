...
// 复合主键 + composite_index（EX-SC-002）。
type Lister struct {
...
const file_list_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"list.proto\x12\x06pbtest\x1a\x10orm.option.proto\"\x82\x01\n" +
	"\x06Lister\x12\x1c\n" +
	...
	"\x04data\x18\x03 \x01(\fR\x04data:/\xf0\xa7\x1d\x01\xfa\xa7\x1d\x06social\x80\xa8\x1d\x00\x8a\xa8\x1d\x19idx_lister_rid_id(rid,id)B\vZ\tgs/pbtestb\x06proto3"
